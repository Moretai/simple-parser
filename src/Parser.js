...
class Parser {
   ...
   * EqualityExpression
   *  : RelationExpression
   *  | RelationExpression EQUALITY_OPERATOR EqualityExpression
   */
  EqualityExpression() {
   ...
   * RelationExpression
   *  : AdditiveExpression
   *  | AdditiveExpression RELATIONAL_OPERATOR RelationExpression
   */
  RelationExpression() {
  ...
  /**
   * NewExpression
   *  : 'new' MemberExpression Arguments -> new myNameSpace.ClassA (1, 20);
   */
  NewExpression() {
    this._eat("new");
    return {
